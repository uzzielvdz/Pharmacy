...
<div class="card bg-gray-700 animate-slide-in">
    <div class="card-body">
        <h2 class="card-title text-2xl mb-4">Editar Proveedor</h2>
        <?php if (!empty($errors)): ?>
        ...
        <?php endif; ?>
        <form action="<?php echo BASE_URL; ?>/public/index.php?controller=proveedor&action=update" method="POST" class="row g-3">
            <input type="hidden" name="id" value="<?php echo isset($formData['id_proveedor']) ? htmlspecialchars($formData['id_proveedor']) : ''; ?>">
            <div class="col-md-6">
