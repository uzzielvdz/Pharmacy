...
<div class="card bg-gray-700 animate-slide-in">
    <div class="card-body">
        <h2 class="card-title text-2xl mb-4">Editar Producto</h2>
        <?php if (!empty($errors)): ?>
        ...
        <?php endif; ?>
        <form action="<?php echo BASE_URL; ?>/public/index.php?controller=product&action=update" method="POST" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="precio" step="0.01" min="0" class="form-control" value="<?php echo isset($formData['precio']) ? htmlspecialchars($formData['precio']) : 0; ?>" required>
            </div>
            <div class="col-12">
