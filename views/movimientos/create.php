...
<?php endif; ?>
<form action="<?php echo BASE_URL; ?>/public/index.php?controller=movimiento&action=store" method="POST">
    ...
    <input type="datetime-local" name="fecha" value="<?php echo isset($formData['fecha']) ? htmlspecialchars($formData['fecha']) : ''; ?>" required><br>
