...
<div class="card bg-gray-700 animate-slide-in">
    <div class="card-body">
        <h2 class="card-title text-2xl mb-4">Editar Movimiento</h2>
        <?php if (!empty($errors)): ?>
        ...
        <?php endif; ?>
        <form action="<?php echo BASE_URL; ?>/public/index.php?controller=movimiento&action=update" method="POST" class="row g-3">
